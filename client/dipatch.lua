...
------ Dispatch do roubo ----------
-----------------------------------
RegisterNetEvent('robberycar:server:callCops')
AddEventHandler('robberycar:server:callCops', function()
    ...
    TriggerServerEvent('dispatch:svNotify', {
        ...
        isImportant = true,
        priority = 1,
        dispatchMessage = "Veiculo Encontrado",
        origin = {
          x = plyPos.x,
          y = plyPos.y,
          z = plyPos.z
...
RegisterNetEvent('robberycar:server:callCops1')
AddEventHandler('robberycar:server:callCops1', function()
    local vehicleData = GetVehicleDescription() or {}
    local plyPos = GetEntityCoords(PlayerPedId(), true)
    TriggerServerEvent('dispatch:svNotify', {
        info = 20,
        ...
        isImportant = true,
        priority = 1,
        dispatchMessage = "Veiculo Furtado",
        origin = {
          x = plyPos.x,
          y = plyPos.y,
          z = plyPos.z
